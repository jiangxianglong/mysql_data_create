...
public class PrizePool {
     ...
     * 生成奖池数据
     */
    private static List<String> makePrizePoolData1(String startDate,String endDate) {
        ...
        //优惠券数量
        int couponSize111= 27000;
        int couponSize222= 3800;
        ...
        //prize: 6   周年庆288元优惠券
        addCouponPrize(sqlList,couponSize222,startDate,endDate,6,2,31317);


        //prize: 7   周年庆1000元优惠券
        addCouponPrize(sqlList,couponSize222,startDate,endDate,7,2,31356);


        //prize: 8   周年庆100元优惠券
        addCouponPrize(sqlList,couponSize222,startDate,endDate,8,2,31357);


        //prize: 9   周年庆3000元优惠券
        addCouponPrize(sqlList,couponSize222,startDate,endDate,9,2,31358);


        //prize: 10  周年庆3000元优惠券
        addCouponPrize(sqlList,couponSize222,startDate,endDate,10,2,31359);
...
//        addEneityPrize(sqlList,0,startDate,endDate,11,1,488);
//
//        //prize: 12   510   5    LANCOME小黑瓶精华液
//        addEneityPrize(sqlList,0,startDate,endDate,12,1,510);
//
//        //prize: 13   509   5    populele儿童智能尤克里里
//        addEneityPrize(sqlList,0,startDate,endDate,13,1,509);
//
//        //prize: 14   508   300  全能宝宝梦想盒子
//        addEneityPrize(sqlList,20,startDate,endDate,14,1,508);
//
//        //prize: 15   507   300   绘本
//        addEneityPrize(sqlList,20,startDate,endDate,15,1,507);
//
//        //prize: 16   506   100    热血读书上瘾励志大海报
//        addEneityPrize(sqlList,5,startDate,endDate,16,1,506);
//
//        //prize: 17   505   100      美国哈佛耶鲁牛娃家大海报
//        addEneityPrize(sqlList,5,startDate,endDate,17,1,505);
//
//        //prize: 18   504   100      藐视凡人全球名人名言大海报
//        addEneityPrize(sqlList,5,startDate,endDate,18,1,504);
//
//        //prize: 19   503    30      有声英文单词卡豪华礼盒
//        addEneityPrize(sqlList,0,startDate,endDate,19,1,503);
//
//        //prize: 20   502    300      全家福贴纸
//        addEneityPrize(sqlList,20,startDate,endDate,20,1,502);
//
//        //prize: 21   501    500       杨易第三季文具盒
//        addEneityPrize(sqlList,20,startDate,endDate,21,1,501);


        eneitySeize = sqlList.size() - goldPrizeSize - couponSize;
        /*************************************************     虚拟课程  22 - 33  1：音频  2：伴读 3：直播 4：视频       *****************************************************/

        int courseNum111 = 1400;
        ...
        addCoursePrize(sqlList,120,startDate,endDate,26,3,496,1);
     ...
     * 生成奖池数据
     */
    private static List<String> makePrizePoolData2(String startDate,String endDate) {
        //  `PRIZE_TYPE` int(11) DEFAULT NULL COMMENT '类型 1:实体  2:优惠券 3: 虚拟课程 4:金币',
        List<String> sqlList = new ArrayList<>();
        int goldPrizeSize = 0;
        int couponSize = 0;
...
//
//        //prize: 14   508   300  全能宝宝梦想盒子
//        addEneityPrize(sqlList,15,startDate,endDate,14,1,508);
//
//        //prize: 15   507   300   绘本
//        addEneityPrize(sqlList,15,startDate,endDate,15,1,507);
//
//        //prize: 16   506   100    热血读书上瘾励志大海报
//        addEneityPrize(sqlList,5,startDate,endDate,16,1,506);
//
...
//
//        //prize: 19   503    30      有声英文单词卡豪华礼盒
//        addEneityPrize(sqlList,1,startDate,endDate,19,1,503);
//
//        //prize: 20   502    300      全家福贴纸
//        addEneityPrize(sqlList,20,startDate,endDate,20,1,502);
//
...
//        eneitySeize = sqlList.size() - goldPrizeSize - couponSize;
        ...
        //prize: 26    小学语文文言文精讲音频课   300           496         1
        addCoursePrize(sqlList,0,startDate,endDate,26,3,496,1);
    ...
    public static void addGoldPrize(List<String> sqlList,Integer forEach,String startDate,String endDate,Integer prize,Integer prizeType){
        for (int i = 0; i < forEach; i++) {
            String sql = "  (NULL, '"+startDate+"', '"+endDate+"', NULL, "+prize+", "+prizeType+",0, 0, 0, 0),";
            sqlList.add(sql);
        }
    ...
    public static void addCouponPrize(List<String> sqlList,Integer forEach,String startDate,String endDate,Integer prize,Integer prizeType,Integer couponsId){
        for (int i = 0; i < forEach; i++) {
            String sql = "  (NULL, '"+startDate+"', '"+endDate+"', NULL, "+prize+", "+prizeType+","+couponsId+", 0, 0, 0),";
            sqlList.add(sql);
        }
    ...
    public static void addEneityPrize(List<String> sqlList,Integer forEach,String startDate,String endDate,Integer prize,Integer prizeType,Integer taskPrizeId){
        for (int i = 0; i < forEach; i++) {
            String sql = "  (NULL, '"+startDate+"', '"+endDate+"', NULL, "+prize+", "+prizeType+","+taskPrizeId+", 0, 0, 0), ";
            sqlList.add(sql);
        }
    ...
    public static void addCoursePrize(List<String> sqlList,Integer forEach,String startDate,String endDate,Integer prize,Integer prizeType,Integer taskPrizeId,Integer courseType){
        for (int i = 0; i < forEach; i++) {
            String sql = " (NULL, '"+startDate+"', '"+endDate+"', NULL, "+prize+", "+prizeType+","+taskPrizeId+","+courseType+", 0, 0), ";
            sqlList.add(sql);
        }

    }

    private static  List<String> testSqlList(String startDate,String endDate){
        List<String> sqlList = new ArrayList<>();
        try {


            //prize: 2  周年庆15元优惠券
            addCouponPrize(sqlList,2000,startDate,endDate,2,2,31310);

            //prize: 3   周年庆20元优惠券
            addCouponPrize(sqlList,1000,startDate,endDate,3,2,31311);


            //prize: 4   周年庆35元优惠券
            addCouponPrize(sqlList,1000,startDate,endDate,4,2,31313);


            //prize: 5   周年庆68元优惠券
            addCouponPrize(sqlList,1000,startDate,endDate,5,2,31314);
    ...
    public static void main(String[] args) {
        ...
        List<String> list = makePrizePoolData1(startDate,endDate);
        PrintData.printPrizeInsertSqlText(list, date+" 奖池数据"+PrintData.getNows()+title+".sql");

//
//        String date = "2018-09-07";
//        String startDate = date+" 00:00:00";
//        String endDate = date+" 23:59:59";
//        List<String> list = makePrizePoolData2(startDate,endDate);
//        PrintData.printPrizeInsertSqlText(list, date+" 奖池数据 补充"+PrintData.getNows()+title+".sql");
